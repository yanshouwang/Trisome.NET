...
namespace Trisome.Core.Commands
{
    ...
    {
        readonly List<ICommand> _registeredCommands;
        ...
        {
            _registeredCommands = new List<ICommand>();
            _onRegisteredCommandCanExecuteChangedHandler = new EventHandler(this.OnRegisteredCommandCanExecuteChanged);
        ...
        public virtual void RegisterCommand(ICommand command)
        {
            ...
            if (_monitorCommandActivity)
            {
                ...
                {
                    activeAwareCommand.ActiveChanged += OnCommandActiveChanged;
                }
            }
        }
        ...
        protected virtual bool ShouldExecute(ICommand command)
        {
            ...
            {
                return activeAwareCommand.Active;
            }
        ...
        void OnCommandActiveChanged(object sender, EventArgs e)
        {
            OnCanExecuteChanged();
        }
    }
