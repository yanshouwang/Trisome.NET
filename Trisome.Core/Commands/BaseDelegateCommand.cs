...
namespace Trisome.Core.Commands
{
    ...
    public abstract class BaseDelegateCommand : ICommand, IActiveAware
    {
        ...
        readonly HashSet<string> _observedPropertiesExpressions;
        ...
        protected BaseDelegateCommand()
        {
            ...
            _observedPropertiesExpressions = new HashSet<string>();
        }
        ...
        protected virtual void OnCanExecuteChanged()
        {
            ...
            if (handler != null)
            {
                if (_synchronizationContext != null && _synchronizationContext != SynchronizationContext.Current)
                    _synchronizationContext.Post(i => handler.Invoke(this, EventArgs.Empty), null);
                else
        ...
        /// <summary>
        /// Fired if the <see cref="Active"/> property changes.
        /// </summary>
