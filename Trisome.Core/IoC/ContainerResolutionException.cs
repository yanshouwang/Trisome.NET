...
namespace Trisome.Core.IoC
{
    ...
    public class ContainerResolutionException : Exception
    {
        ...
        // Used by GetErrors()
        ContainerResolutionException(Type serviceType, string message)
            : base(message)
        {
            ServiceType = serviceType;
        }
        ...
        static void PopulateErrors(Type implementingType, ref ContainerResolutionErrorCollection errors)
        {
        ...
        static string GetErrorMessage(Type type, string name)
        {
