...
namespace Trisome.DryIoC.WPF
{
    ...
    public
#endif
    class ContainerExtension : IContainerExtension<IContainer>, IContainerInfo
    {
        DryIocScopedProvider _currentScope;
        ...
        class DryIocScopedProvider : IScopedProvider
        {
            ...
            public IResolverContext Resolver { get; set; }
