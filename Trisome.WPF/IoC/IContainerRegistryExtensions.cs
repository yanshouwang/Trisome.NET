...
namespace Trisome.WPF.IoC
{
    ...
    public static class IContainerRegistryExtensions
    {
        ...
        static void RegisterForNavigationWithViewModel<TViewModel>(this IContainerRegistry containerRegistry, Type viewType, string name)
        {
