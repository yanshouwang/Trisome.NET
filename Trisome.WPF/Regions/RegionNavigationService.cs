...
namespace Trisome.WPF.Regions
{
    ...
    public class RegionNavigationService : IRegionNavigationService
    {
        ...
        readonly IRegionNavigationContentLoader _regionNavigationContentLoader;
        NavigationContext _currentNavigationContext;
        ...
        public void Navigate(Uri target, Action<NavigationResult> navigationCallback, IDictionary<string, object> args)
        {
            ...
            try
            {
                DoNavigate(target, navigationCallback, args);
            }
            catch (Exception e)
            {
        ...
        void DoNavigate(Uri source, Action<NavigationResult> navigationCallback, IDictionary<string, object> args)
        {
            if (source == null)
            ...
            _currentNavigationContext = new NavigationContext(this, source, args);
        ...
        void RequestCanNavigateFromOnCurrentlyActiveView(NavigationContext navigationContext, Action<NavigationResult> navigationCallback, object[] activeViews, int currentViewIndex)
        {
        ...
        void RequestCanNavigateFromOnCurrentlyActiveViewModel(NavigationContext navigationContext, Action<NavigationResult> navigationCallback, object[] activeViews, int currentViewIndex)
        {
        ...
        void NotifyNavigationFailed(NavigationContext navigationContext, Action<NavigationResult> navigationCallback, Exception e)
        {
        ...
        static void NotifyActiveViewsNavigatingFrom(NavigationContext navigationContext, object[] activeViews)
        {
