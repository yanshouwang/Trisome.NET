...
namespace Trisome.WPF.Regions
{
    ...
    /// </summary>
    public class SelectorRegionAdapter : BaseRegionAdapter<Selector>
    {
        /// <summary>
        ...
        protected override void AttachBehaviors(IRegion region, Selector regionTarget)
        {
            ...
            region.Behaviors.Add(SelectorItemsSourceSyncBehavior.KEY, new SelectorItemsSourceSyncBehavior() { HostControl = regionTarget });
