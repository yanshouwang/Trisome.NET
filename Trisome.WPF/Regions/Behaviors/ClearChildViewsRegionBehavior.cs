...
namespace Trisome.WPF.Regions.Behaviors
{
    ...
    public class ClearChildViewsRegionBehavior : RegionBehavior
    {
        ...
        /// The behavior key.
        /// </summary>
        public const string KEY = "ClearChildViews";
        ...
        static void ClearChildViews(IRegion region)
        {
            foreach (var view in region.Views)
            {
                if (view is DependencyObject dependencyObject && GetClearChildViews(dependencyObject))
                {
