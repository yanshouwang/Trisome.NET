...
namespace Trisome.WPF.Regions
{
    ...
    public interface INavigateAsync
    {
        ...
        /// <see cref="NavigationAsyncExtensions"/> class.
        /// </remarks>
        void Navigate(Uri target, Action<NavigationResult> navigationCallback);
        ...
        /// <see cref="NavigationAsyncExtensions"/> class.
        /// </remarks>
        void Navigate(Uri target, Action<NavigationResult> navigationCallback, IDictionary<string, object> args);
    }
}