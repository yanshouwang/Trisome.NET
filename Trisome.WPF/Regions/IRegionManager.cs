...
namespace Trisome.WPF.Regions
{
    ...
    public interface IRegionManager
    {
        ...
        void Navigate(string regionName, Uri source, Action<NavigationResult> navigationCallback);
        /// <summary>
        /// Navigates the specified region manager.
        /// </summary>
        /// <param name="regionName">The name of the region to call Navigate on.</param>
        /// <param name="source">The URI of the content to display.</param>
        void Navigate(string regionName, Uri source);
        /// <summary>
        /// Navigates the specified region manager.
        /// </summary>
        /// <param name="regionName">The name of the region to call Navigate on.</param>
        /// <param name="source">The URI of the content to display.</param>
        /// <param name="navigationCallback">The navigation callback.</param>
        void Navigate(string regionName, string source, Action<NavigationResult> navigationCallback);
        /// <summary>
        /// Navigates the specified region manager.
        /// </summary>
        /// <param name="regionName">The name of the region to call Navigate on.</param>
        ...
        void Navigate(string regionName, Uri target, Action<NavigationResult> navigationCallback, IDictionary<string, object> args);
        /// <summary>
        ...
        /// <param name="navigationCallback">The navigation callback that will be executed after the navigation is completed.</param>
        /// <param name="navigationParameters">An instance of NavigationParameters, which holds a collection of object parameters.</param>
        void Navigate(string regionName, string target, Action<NavigationResult> navigationCallback, IDictionary<string, object> args);
        /// <summary>
        ...
        /// <param name="target">A Uri that represents the target where the region will navigate.</param>
        /// <param name="navigationParameters">An instance of NavigationParameters, which holds a collection of object parameters.</param>
        void Navigate(string regionName, Uri target, IDictionary<string, object> args);
        /// <summary>
        ...
        /// <param name="target">A string that represents the target where the region will navigate.</param>
        /// <param name="navigationParameters">An instance of NavigationParameters, which holds a collection of object parameters.</param>
        void Navigate(string regionName, string target, IDictionary<string, object> args);
    }
}