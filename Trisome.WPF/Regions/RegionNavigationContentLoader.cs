...
namespace Trisome.WPF.Regions
{
    ...
    public class RegionNavigationContentLoader : IRegionNavigationContentLoader
    {
        ...
        IEnumerable<object> GetCandidatesFromRegionViews(IRegion region, string candidateNavigationContract)
        {
            return region.Views.Where(v => ViewIsMatch(v.GetType(), candidateNavigationContract));
        }

        static bool ViewIsMatch(Type viewType, string navigationSegment)
        {
